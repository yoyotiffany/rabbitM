...
public class MQConstants {
	...
	/**你的业务交换机名称*/
	public static final String BUSINESS_EXCHANGE = "YQ_TEST";
	/**你的业务队列名称*/
	public static final String BUSINESS_QUEUE = "TEST_QUEUE_YQ";
	/**你的业务key*/
	public static final String BUSINESS_KEY = "test.yq";
	...
	/**死信队列配置*/
	public static final String DLX_EXCHANGE = "DLX_YQ_TEST";
	public static final String DLX_QUEUE = "DLX_TEST_QUEUE_YQ";
	public static final String DLX_ROUTING_KEY = "test.yq";
	/**发送端重试乘数(ms)*/
